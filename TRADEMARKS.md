...
**Official status principle:** only Macro Evidence's own repositories, domains, and accounts under its control represent the official Macro Evidence project. No fork, derivative, service, or third party is official, endorsed, or affiliated unless Macro Evidence has explicitly designated it as such.
...
This document does not extend to hypothetical future marks, sub-brands, or product names. New marks are added to the table above through a routine update to this policy, not assumed to be covered in advance.
...
## 5. Fork & Derivative Policy

You may fork, modify, self-host, and redistribute Macro Evidence code and content according to the terms of the applicable repository license. This section addresses what forking does not include: permission to carry Macro Evidence's identity with it.
...
- Choose a distinct name and visual identity for itself.
...
- This policy does not establish specific penalties or enforcement mechanisms beyond the trademark rights described above.

---

## 11. Not Legal Advice

This document is Macro Evidence's trademark policy, not a substitute for legal advice. If you have questions about whether a specific use is permitted, or you're seeking legal guidance for your own project, consult a qualified attorney in your jurisdiction.
